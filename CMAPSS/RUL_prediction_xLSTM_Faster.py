...
parser.add_argument('--oc', type=int, default=1, help='operation condition')
parser.add_argument('--device', type=int, default=0, help='device')
flight_condition = parser.parse_args().oc
...
# 保存这个torch模型
torch.save(model, f'model_{flight_condition}.pt')
# %% [markdown]
