...
sys.path.append('/kaggle/input/n-cmpass3/')
...
def load_model():
    ...
    checkpoint = torch.load("model/kanxlstm.pth", map_location=device, weights_only=True)
...
if __name__ == "__main__":
    interface.launch(share=True)  # 生成临时公共链接
